...
from gmail_service import (
    get_gmail_service,
    ensure_caixa_limpa_labels,
    mover_para_quarentena,
)

app = FastAPI()

# Templates e arquivos estáticos (página bonita)
...
def auth_callback(request: Request):
    ...
    # Limpeza inicial: quarentena (por enquanto)
...
def cron_cleanup(secret: str, max: int = 200):
    ...
    return {
        ...
        "total_movidos_quarentena": total_moved,
    }
